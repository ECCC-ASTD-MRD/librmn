...
* */
	...
	subroutine RPN_COMM_compress(array,minx,maxx,miny,maxy,
     %                           nil,njl,nk)
	implicit none
	integer minx,maxx,miny,maxy,nil,njl,nk
	integer array(*)
*
...
*VDIR NODEP
	...
	enddo
*
	entry RPN_COMM_compress8(array,minx,maxx,miny,maxy,
     %                           nil,njl,nk)
*
...
*
*
	entry RPN_COMM_expand(array,minx,maxx,miny,maxy,
     %                           nil,njl,nk)
*
	compressed_ = loc(array)
	expanded_ = loc(array)
...
*
*
	entry RPN_COMM_expand8(array,minx,maxx,miny,maxy,
     %                           nil,njl,nk)
*
	compressed8_ = loc(array)
	expanded8_ = loc(array)
