...
void  packTokensParallelogram(unsigned int z[], int *zlng, unsigned short ufld[], int ni, int nj, int nbits, int istep, uint32_t *header);
...
void c_fstzip_sample(unsigned int *zfld, int *zlng, unsigned short *fld, int ni, int nj, int step, int nbits, uint32_t *header);
...
void c_fstzip(unsigned int *zfld, int *zlng, unsigned int *fld, int ni, int nj, int code_methode, int degre, int step, int nbits, int bzip)
{
  ...
  switch (code_methode)
    ...
    case SAMPLE:
      ...
      exit(13);
/*      c_fstzip_sample(zfld, zlng, (unsigned short *)fld, ni, nj, step, nbits, (uint32_t *) &zfstzip);*/
      break;
