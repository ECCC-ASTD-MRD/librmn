...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
int32_t ez_defzones(int32_t gdin, int32_t gdout);/*, int32_t gdin, float *x, float *y, int32_t npts, _zone *zones);*/
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
//void c_gdkey2rowcol(int32_t key, int32_t *row, int32_t *col);
//void c_gdrowcol2key(int32_t *key, int32_t row, int32_t col);
