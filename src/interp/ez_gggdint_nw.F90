...
subroutine ez_gggdint_nw(zo, px, py, npts, ay, z, i1, i2, j1, j2)
    ...
    !> Source grid start index along the X dimension
    integer, intent(in) :: i1
    !> Source grid end index along the X dimension
    integer, intent(in) :: i2
    !> Source grid start index along the Y dimension
    integer, intent(in) :: j1
    !> Source grid end index along the Y dimension
