...
#include "ez_def_shared.h"
    ...
    integer, parameter :: maxroots = 5120
    real, save :: lroots(maxroots)

    integer             :: i, j
    real(kind = real64) :: x2, y2, xy, x3, y3, x2y, xy2
    real(kind = real32) :: pi, pj, dlon
    real(kind = real64) :: a(6, 6), b(6), vpole, det, deta, detb, detc
    integer             :: l(6), m(6)
    integer             :: n, nglat
    ...
    if (ordint .ne. VOISIN .and. ordint .ne. LINEAIRE .and. ordint .ne. CUBIQUE) then
