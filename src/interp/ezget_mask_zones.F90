subroutine qqq_ezget_mask_zones(mask_zones, x, y, ni_out, nj_out, mask_in, ni_in, nj_in)
    ...
    integer, intent(in) :: ni_out, nj_out, ni_in, nj_in
    integer, intent(out) :: mask_zones(ni_out, nj_out)
    integer, intent(in) :: mask_in(ni_in, nj_in)
    real, intent(in) :: x(ni_out, nj_out), y(ni_out, nj_out)
...
subroutine qqq_ezsint_mask(mask_out, x, y, ni_out, nj_out, mask_in, ni_in, nj_in)
    ...
    integer, intent(in) :: ni_out, nj_out, ni_in, nj_in
    integer, intent(out) :: mask_out(ni_out, nj_out)
    integer, intent(in) :: mask_in(ni_in, nj_in)
    real, intent(in) :: x(ni_out, nj_out), y(ni_out, nj_out)

    integer, external :: ezgetopt

    character(len = 32) :: value
    integer :: i, j, ix, iy, nix, niy, ier
