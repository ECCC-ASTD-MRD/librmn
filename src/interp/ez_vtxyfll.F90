...
subroutine ez_vtxyfll(x, y, lat, lon, clat, clon, d60, dgrw, ni, nj, n)
    ...
    real, intent(in) :: lat(n), lon(n), clat, clon, d60
    real, intent(in) :: dgrw ! Unused

    real, parameter :: r = 6371000.0

    integer :: i
    real :: k, sinclat, cosclat, offsetx, offsety
...
subroutine ez_vtllfxy(lat, lon, x, y, clat, clon, d60, dgrw, ni, nj, n)
    ...
    real, intent(out) :: lat(n), lon(n)
    real, intent(in) :: clat, clon, d60
    real, intent(in) :: dgrw ! Unused

    real, parameter :: r = 6371000.0

    integer :: i
    real :: rho, c, a, b, temp, sinclat, cosclat, offsetx, offsety
