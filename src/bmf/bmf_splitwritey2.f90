...
!> \deprecated
subroutine bmf_splitwritey2(comm_split_func,nom,gni,gnj,nk,time1,time2, &
...
! the second ("y") axis
  ...
  nullify(p_vecteur)
  ierr= comm_split_func(0,1,gni,minx,maxx,nxl,nxlmax, &
                    halox,nx0,fill)
  if(ierr.ne.0) then
       write(*,*) 'BMF_SPLITWRITEY: error comm_split_func, abort'
       stop
  endif
  do py=0,bmf_npey-1
