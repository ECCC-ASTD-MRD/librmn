...
int32_t f77name(mrbini)(int32_t *iun, int32_t buf[], int32_t *temps, int32_t *flgs, char stnid[],
                        ...
                        int32_t *drcv, int32_t *date, int32_t *oars, int32_t *runn, int sup[], int32_t *nsup,
...
int32_t f77name(mrbupd)(int32_t *iun, int buf[], int32_t *temps, int32_t *flgs, char stnid[], int32_t *idtp,
                        ...
                        int32_t *nsup, int xaux[], int32_t *nxaux, F2Cl l1);
int32_t f77name(mrfcls)(int32_t *iun);
...
int32_t f77name(mrfprm)(int32_t *handle, char stnid[10], int32_t *idtyp, int32_t *lat, int32_t *lon, int32_t *dx,
                        int32_t *dy, int32_t *date, int32_t *temps, int *flgs, int32_t sup[], int32_t *nsup,
                        int32_t *lng, F2Cl l1);
