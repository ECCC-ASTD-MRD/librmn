...
fst_file*   fst24_open_link(const char** const filePaths, const int32_t fileNb);
int32_t     fst24_close(fst_file* const file);
int32_t     fst24_close_unlink(fst_file* const file);
...
fst_record fst24_decode_data_rsf(const void* data, void* dest);
