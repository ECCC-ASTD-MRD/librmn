...
ftnword f77name(xdfopn)(int32_t *fiun, char *mode, ftnword_2 *pri, int32_t *fnpri,
...
ftnword f77name(xdfcls)(int32_t *fiun);
int c_xdfcls(int iun);
ftnword f77name(xdfsta)(int32_t *fiun, int32_t *stat, int32_t *fnstat,
...
int c_xdfsta(int iun, int32_t *stat, int nstat,
                    ...
                    char *vers, char *appl);
ftnword f77name(xdfimp)(int32_t *fiun, int32_t *stat, int32_t *fnstat,
                    ftnword_2 *pri, ftnword_2 *aux,
                    char *vers, char *appl, F2Cl l1, F2Cl l2);
int c_xdfimp(int iun, int32_t *stat, int nstat, word_2 *pri, word_2 *aux,
                    char *vers, char *appl);
ftnword f77name(xdfini)(int32_t *fiun, int32_t *buf, int32_t *fidtyp,
...
ftnword f77name(xdfget)(int32_t *fhandle, int32_t *buf);
int c_xdfget(int handle, buffer_interface_ptr buf);
ftnword f77name(xdfput)(int32_t *fiun, int32_t *fhandle,
            int32_t *buf);
int c_xdfput(int iun, int handle, buffer_interface_ptr buf);
ftnword f77name(xdfopt)(char *foptname, char *foptc, int32_t *foptv,
            F2Cl l1, F2Cl l2);
int c_xdfopt(char *optname, char *optc, int optv);
ftnword f77name(xdfgop)(char *foptname, char *foptc, int32_t *foptv,
            F2Cl l1, F2Cl l2);
int c_xdfgop(char *optname, char *optc, int *optv);
ftnword f77name(xdfins)(int32_t *buf, int32_t *donnees,
...
ftnword f77name(xdfxtr)(int32_t *buf, int32_t *donnees,
                        int32_t *fbitpos, int32_t *fnelm,
            int32_t *fnbits, int32_t *fdatyp);
int c_xdfxtr(int32_t *buffer, int32_t *donnees, int bitpos,
             int nelm, int nbits, int datyp);
ftnword f77name(xdfrep)(int32_t *buf, int32_t *donnees,
                        int32_t *fbitpos, int32_t *fnelm,
            int32_t *fnbits, int32_t *fdatyp);
int c_xdfrep(int32_t *buffer, int32_t *donnees, int bitpos,
         int nelm, int nbits, int datyp);
ftnword f77name(xdfcut)(int32_t *buf,
            int32_t *fbitpos, int32_t *fnelm,
            int32_t *fnbits, int32_t *fdatyp);
int c_xdfcut(void *buffer, int bitpos, int nelm, int nbits, int datyp);
ftnword f77name(xdfupd)(int32_t *fiun, int32_t *buf,
            int32_t *fidtyp,
            int32_t *keys, int32_t *fnkeys,
            int32_t *info, int32_t *fninfo);
int c_xdfupd(int iun, buffer_interface_ptr buf, int idtyp,
             int32_t *keys, int nkeys, int32_t *info, int ninfo);
ftnword f77name(xdfuse)(int32_t *fsrc_unit, int32_t *fdest_unit);
int c_xdfuse(int src_unit, int dest_unit);
ftnword f77name(xdfcle)(char *fkeyname, int32_t *fbit1, int32_t *flkey,
...
ftnword f77name(qdfmsig)(int32_t *fiun, char *appl, F2Cl l1);
ftnword f77name(mrbdel)(int32_t *buf, int32_t *f_number);
int c_mrbdel(void *buffer, int number);
ftnword f77name(xdflnk)(int32_t *liste, int32_t *fn);
ftnword f77name(fstvoi)(int32_t *f_iun, char *options, F2Cl l1);
ftnword f77name(fstouv)(int32_t *f_iun, char *options, F2Cl l1);
ftnword f77name(secateur)(char *filename, int32_t *f_where, F2Cl l1);
