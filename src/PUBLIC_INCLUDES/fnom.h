...
ftnword f77name(waread2)(int32_t *fiun, void *buf, uint32_t *fadr, int32_t *fnmots);
int32_t c_wasize(int iun);
ftnword f77name(wasize)(int32_t *fiun);
int32_t c_numblks(int iun);
ftnword f77name(numblks)(int32_t *fiun);
...
ftnword f77name(getfdsc)( int32_t *iun);
...
ftnword f77name(sqgets)(int32_t *iun, char  *bufptr, int32_t *nchar, F2Cl lbuf);
int c_sqputs(int iun, char *bufptr, int nchar);
ftnword f77name(sqputs)(int32_t *iun, char  *bufptr, int32_t *nchar, F2Cl lbuf);
