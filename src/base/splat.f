...
*-------------------------------------------------------------------------------
*
      CHARACTER(len = 1) :: NG(101),S(4),IGR(15)
      DATA S/' ','I','-','*'/
      DATA IGR/'1','2','3','4','5','6','7','8','9',
     1         'A','B','C','D','E','F'/
*
*-----------------------------------------------------------------------
*
...
*-----------------------------------------------------------------------
*
  605 FORMAT('1 CURVE ', A1, T87, 'RANGE =', 1PE12.5)
  610 FORMAT(' ', 16X, 1PE12.5, T68, E12.5, T118, E12.5)
  615 FORMAT(' ', 21X, 10('I---------'), 'I')
  620 FORMAT(' ', I4, 1PE15.6, 2X, 101A1)
  625 FORMAT(' ', 21X, 101A1)
      END
