...
void f77name(cmain)()
{
  ...
  int32_t arrayOfInt3[myElementCount3], arrayOfInt4[myElementCount3];
  int32_t arrayOfInt5[myElementCount3], arrayOfInt6[myElementCount3], arrayOfInt7[myElementCount3];
