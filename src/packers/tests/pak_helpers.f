...
*   Author    : Jianhui He                                             *
*                                                                      *
*   Objective : obtain an array of float from an array of integer on   *
*               NEC                                                    *
*                                                                      *
*   Arguments :                                                        *
...
*   Author    : Jianhui He                                             *
*                                                                      *
*   Objective : obtain an array of double from an array of integer on  *
*               NEC                                                    *
*                                                                      *
*   Arguments :                                                        *
*     IN    IPAK     array of integer                                  *
...
*  Author    : Jianhui He                                              *
*                                                                      *
*  Objective : transform an array of integer into a continguous bit    *
*              stream on NEC when bit size of packed integer is 16     *
*                                                                      *
*  Arguments :                                                         *
...
*    IN    offset   last bit of integer packed into the packed integer *
*                   array                                              *
...
*  Author    : Jianhui He                                              *
*                                                                      *
*  Objective : transform a continguous bit stream to an array of       *
*              integer on NEC when bit size of packed integer is 16    *
*                                                                      *
*  Arguments :                                                         *
*    IN    IUNP     unpacked integer array                             *
*    OUT   IPAK     packed integer array                               *
