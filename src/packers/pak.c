                 ...
                 int32_t *NB, int32_t *OP)
{
  ...
  int32_t *tempPackedArray,  *dummyArray, *tempUnpackedArray;
  int32_t *ptrXpacked, *ptrXUnpacked, *transitPtr;
   ...
   *************************************************************************/ 
      ...
      *********************************************************/
      ...
      ptrXpacked   = NULL;
      ptrXpacked   = (int32_t *)xpacked;
      ptrXUnpacked = NULL;
      ptrXUnpacked = (int32_t *)xunpacked; 
      ...
      tempPackedArray = ( int32_t *) malloc(lengthOfPackedArray*sizeof(int32_t));
                      ...
                      int32_t *NB, int32_t *OP)
{
  ...
  int lnBits = (*nBits);
  int OPER = (*OP);
  int32_t *tempIntArray;
  int lengthOfIntArray;
  int32_t *tempFloatArray;
  ...
  if ( xunpacked == xpacked )
    ...
    {  
      ...
      tempIntArray = NULL;    
      tempIntArray = ( int32_t *) malloc(lengthOfIntArray*sizeof(int32_t));  
