...
void c_llwfgfw_turbo(ftnfloat *uullout, ftnfloat *vvllout, ftnfloat *latin, ftnfloat *lonin,
		     ...
		     char *grtyp,wordint *ig1,wordint *ig2,wordint *ig3,wordint *ig4)
{
  ...
  f77name(ez_uvacart_turbo)(xyz, uullout, vvllout, sinlat, sinlon, coslat, coslon, ni, nj); 
  f77name(mxm)(ri, &trois, xyz, &trois, uvcart, &npts);
  
  f77name(ez_cartauv_turbo)(uullout, vvllout, uvcart, sinlatp, sinlonp, coslatp, coslonp, ni, nj); 
  grtypl[0] = 'L';
