...
*
     ...
     %1800,3600,0,0,975,42,910222,65535,1,SUP,NSUP,XAUX,NXAUX)
      NSUP = 0
      NXAUX = 0
      IER2 = MRBINI(10,BUFB,0222,ishft(-1,-(32-(5))),'STATION#2',3,
     %900,1200,1500,1200,240,30,910223,60,1,SUP,NSUP,XAUX,NXAUX)
      NSUP = 0
      NXAUX = 0
...
23124 CONTINUE 
     ...
     %1800,3600,0,0,975,42,920108,65535,1,SUP,NSUP,XAUX,NXAUX)
      IER = MRBHDR(BUFA,TEMPS,FLGS,STNID,IDTYP,LATI,LONG,DX,DY,ELEV,
     %DRCV,DATE,OARS,RUN,NBLK,SUP,NSUP,XAUX,NXAUX)
      WRITE(6,*)' TEMPS = ',TEMPS
      WRITE(6,*)' FLGS  = ',FLGS
