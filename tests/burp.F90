...
!#include <rmn/IgnoreTypeKindRank.hf>
    ...
    WRITE(6,333) 7.1,'MRBLOC BFAM =3,BDESC=-1,BTYP=7 BUFA-BUFB-BUFC'
    !     n'existe pas
    ...
    IER2 = -IER2
    CALL TESTIT(IER+IER1+IER2)
    WRITE(6,333) 7.2,'MRBLOC BFAM =5,BDESC=0,BTYP=7 BUFA-BUFB-BUFC'
    !     n'existe pas
    ...
    DO I =4,6
        ...
        DO J = 1,100
            IER = MRBUPD(10,BUFA,1129,255,STNID,3,4523,26300,0,0,J,      32,901029,0,2,SUP,0,XAUX,0)
    ...
    IER = MRFPRM(IER1,STNID,IDTYP,LATI,LONG,DX,DY,DATE,TEMPS,FLGS,SUP,0,LONENR)
    CALL TESTIT(IER)
    WRITE(6,850)
    ...
    IF((DEF2(5).EQ. 'NUL'))THEN
        ...
        DO I=1,8000
            IER=IER + MRBUPD(20,BUFB,1200,122,'STATION#9',4,2300,      18934,1500,1200,1452,3,I,0,2,SUP,0,XAUX,0)
    ...
    DO I = 1,20
        CALL REMPLI(TBLVAL,10,5,7)
        IER1 = MRBADD(BUFA,BLKNO,10,5,7,5,12,MRBTYP(3,I,13,-1),32,   BIT0,2,LSTELEA,TBLVAL)
        IER = IER + IER1
        PRINT *,' *** INFO BLKNO, BIT0 = ',BLKNO,BIT0
    END DO
    CALL TESTIT(IER)
    ...
    IER1 = MRBADD(BUFA,BLKNO,10,1,1,1,0,MRBTYP(3,I,13,-1),32,BIT0,6,rliste8,rtablo)
    ...
    IER1 = MRBADD(BUFA,BLKNO,20,1,1,2,0,MRBTYP(3,I,13,-1),32,     BIT0,7,rliste8,rtablo8)
    ...
    IER1 = MRBADD(BUFA,BLKNO,20,1,1,3,0,MRBTYP(3,I,13,-1),32,     BIT0,8,cliste,ctablo)
    ...
    IER1 = MRBADD(BUFA,BLKNO,40,1,1,4,0,MRBTYP(3,I,13,-1),32,     BIT0,9,cliste8,ctablo8)
